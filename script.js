...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.server-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            if(this.classList.contains('server-1')) {
                ...
                window.open('https://cxh.pages.dev/p/?id=Sky', '_blank');
            }
    ...
    // Remove hotstar button click handler
    const hotstarBtn = document.querySelector('.watch-btn.hotstar');
    if (hotstarBtn) {
        hotstarBtn.removeEventListener('click', null);
    }
    ...
    function updateTodayMatch() {
        const matches = {
            ...
            '2025-03-23': {
                ...
                time: '7:30 PM IST',  
                venue: 'Mullanpur Stadium, Punjab'
            },
            '2025-03-24': {
                team1: {
                    code: 'RR',
            ...
            // Add more matches here following the same pattern
        };
    ...
    function updateProfileInfo() {
        ...
        if (loginState.isLoggedIn) {
            ...
            if (navLogo) {
                ...
                // Update profile HTML with premium badge
                profileContainer.innerHTML = `
                    ${profileData.profilePic ? `
                        <img src="${profileData.profilePic}" alt="Profile" class="nav-profile-pic">
                    ` : ''}
